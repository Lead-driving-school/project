...
function loadPreSelectedVehicles(){
    ...
    let url="http://localhost/project/Manager/loadPreSelectedVehiclesS/"
...
function loadUnselectedVehicles(){
    ...
    let url="http://localhost/project/Manager/loadUnselectedVehiclesS/"
    httpreq.open("POST",url,true)
    httpreq.send()
}
...
function removeVehicles(vehicleId){
    ...
    let url="http://localhost/project/Manager/removeVehiclesS/"+vehicleId
    httpreq.open("POST",url,true)
    httpreq.send()
}
function addNewVehicles(vehicleId){
    ...
    let url="http://localhost/project/Manager/addNewVehiclesS/"+vehicleId
    httpreq.open("POST",url,true)
    httpreq.send()
}