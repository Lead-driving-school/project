...
function loadPreSelectedInstructors(){
    ...
    let url="http://localhost/project/Manager/loadPreSelectedInstructors/"
...
function loadUnselectedInstructors(){
    ...
    let url="http://localhost/project/Manager/loadUnselectedInstructors/"
    httpreq.open("POST",url,true)
    httpreq.send()
...
function removeInstructor(employeeId){
    ...
    let url="http://localhost/project/Manager/removeInstructor/"+employeeId
    httpreq.open("POST",url,true)
    httpreq.send()
}
function addNewInstructor(employeeId){
    ...
    let url="http://localhost/project/Manager/addNewInstructor/"+employeeId
    httpreq.open("POST",url,true)
    httpreq.send()
}