function viewSession(){
    ...
    let url="http://localhost/project/Receptionist/getSessionDetails"
...
function viewInstructor(){
    ...
    window.location.href="http://localhost/project/Receptionist/viewInstructorS/"
}
function viewVehicle(){
    window.location.href="http://localhost/project/Receptionist/viewVehicleS/"

}
function viewStudents(){
    window.location.href="http://localhost/project/Receptionist/viewStudentS/"
}