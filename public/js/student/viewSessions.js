function viewSession(){
    ...
    let url="http://localhost/project/Student/getSessionDetails"
...
function viewInstructor(){
    ...
    window.location.href="http://localhost/project/Student/viewInstructorS/"
}
function viewVehicle(){
    window.location.href="http://localhost/project/Student/viewVehicleS/"

}
function viewStudents(){
    window.location.href="http://localhost/project/Student/viewStudentS/"
}
function sendRequestsforSession(){
    console.log("hi")
    let httpreq = new XMLHttpRequest();
    httpreq.onreadystatechange=function(){
        if(httpreq.readyState===4 && httpreq.status===200){
    ...
    let url="http://localhost/project/Student/requestForSession/"
    httpreq.open("POST",url,true)
    httpreq.send()
}