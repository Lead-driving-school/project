        ...
        <div class="mid-box-container-2">
            ...
            <div class="mid-box-details-container" id="mid-box-details-container">
                <div class="box-row">
                    ...
                    <div class="box-column-2" id="emId">St_1</div>  
                </div>
                <div class="box-row">
                    <div class="box-column-1"><h4>Name with initial</h4><h4>:</h4></div> 
                    <div class="box-column-2" id="intname">W.D.K.G.G.S. weerasinghe</div>  
                </div>
                <div class="box-row">
                    <div class="box-column-1"><h4>Full Name</h4><h4>:</h4></div> 
                    <div class="box-column-2" id="fullname">Gihan Sandaruwan Weerasinghe</div>  
                </div>
                <div class="box-row">
                    <div class="box-column-1"><h4>Address</h4><h4>:</h4></div> 
                    <div class="box-column-2" id="address">No-123 Colombo road, Kandy</div>  
                </div>
                <div class="box-row">
                    <div class="box-column-1"><h4>NIC</h4><h4>:</h4></div> 
                    <div class="box-column-2" id="nic">980210324v</div>  
                </div>
                <div class="box-row">
                    <div class="box-column-1"><h4>Gender</h4><h4>:</h4></div> 
                    <div class="box-column-2" id="gender">Male</div>  
                </div>
                <div class="box-row">
                    <div class="box-column-1"><h4>District</h4><h4>:</h4></div> 
                    <div class="box-column-2" id="district">Kandy</div>  
                </div>
                <div class="box-row">
                    <div class="box-column-1"><h4>City</h4><h4>:</h4></div> 
                    <div class="box-column-2" id="city">Pilimathalawa</div>  
                </div>
                <div class="box-row">
                    <div class="box-column-1"><h4>Div sec</h4><h4>:</h4></div> 
                    <div class="box-column-2" id="divsec">Danture</div>  
                </div>
                <div class="box-row">
                    <div class="box-column-1"><h4>Nearest police station</h4><h4>:</h4></div> 
                    <div class="box-column-2" id="police">Kandy</div>  
                </div>
                <div class="box-row">
                    <div class="box-column-1"><h4>Date of birth</h4><h4>:</h4></div> 
                    <div class="box-column-2" id="dob">1998-01-02</div>  
                </div>
                <div class="box-row">
                    <div class="box-column-1"><h4>Contact</h4><h4>:</h4></div> 
                    <div class="box-column-2" id="contact">0778560822</div>  
                </div>
                <div class="box-row">
                    <div class="box-column-1"><h4>Occupation</h4><h4>:</h4></div> 
                    <div class="box-column-2" id="occupation">Student</div>  
                </div>
                <div class="box-row">
                    <div class="box-column-1"><h4>Student type</h4><h4>:</h4></div> 
                    <div class="box-column-2" id="type">Written</div>  
                </div>
                <div class="box-row">
                    <div class="box-column-1"><h4>Arival date</h4><h4>:</h4></div> 
                    <div class="box-column-2" id="arivaldate">2020-02-14</div>  
                </div>
