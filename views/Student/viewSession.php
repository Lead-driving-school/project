            ...
            <div class="body-content">
                <div class="form-content">
                    ...
                    <div class="add-instructor-class">
                        ...
                        <a href="<?php echo URL?>Student/viewInstructorS"><button class="session-buttons" name="add-instructor" id="add-instructor">View Instructor</button></a>
                        <div class="blank"></div>
                    </div>
                    <div class="add-vehicle-class">
                        <label for="add-vehicle">Vehicle:</label>
                        <a href="<?php echo URL?>Student/viewVehicleS"><button class="session-buttons" name="add-vehicle" id="add-vehicle">View Vehicle</button></a>
                        <div class="blank"></div>
                    </div>
                    ...
                    <div class="add-student-class">
                        ...
                        <a href="<?php echo URL?>Student/viewStudentS"><button class="session-buttons" name="add-participants" id="add-participants">View Students</button></a>
                        <div class="blank"></div>
                    </div>
                </div>
