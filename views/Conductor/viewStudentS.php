...
<body>
<input type="hidden" id="idContainer" value="<?php echo isset( $_SESSION['viewSessionIdInstructor'])? $_SESSION['viewSessionIdInstructor']:"";?>">
    ...
    <script src="<?php echo URL?>public/js/instructor/viewStudentS.js"></script>
